  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed md:relative top-[5.5rem] md:top-auto left-4 md:left-auto right-4 md:right-auto w-[calc(100%-2rem)] md:w-auto bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden max-h-[calc(100dvh-7rem)] md:max-h-[calc(100vh-7rem)] flex flex-col z-50 md:z-10"
      >
        {/* Scrollable wrapper */}
